...
execute @a[tag=admin,scores={admintp=130}] ~ ~ ~ tp @s 8000 64 61000
execute @a[scores={admintp=130},tag=admin] ~ ~ ~ scoreboard players set @s admintp 150
execute @a[scores={admintp=150,language=0},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§a操作成功！§f您使用了管理员系统进行了传送，您现在位于 §l§3Island_456 §r§f。"}]}
execute @a[scores={admintp=150,language=1},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aOperation successful! §fYou used the administrator system for the transfer and you are now on §l§3Island_456 §r§f."}]}
execute @a[scores={admintp=150,language=2},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§a操作成功！§f您使用了管理員系統進行了傳送，您現在位於 §l§3Island_456 §r§f。"}]}
execute @a[scores={admintp=150,language=3},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§a操作が成功しました！§f管理者システムを使って転送しました。今は §l§3Island_456 §r§fにいます。"}]}
execute @a[scores={admintp=150,language=4},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aOpération réussie! §fVous avez utilisé le système d 'administrateur pour la transmission, et vous êtes maintenant à §l§3Island_456 §r§f."}]}
execute @a[scores={admintp=150,language=5},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aOperación exitosa! §fHa utilizado el sistema de Administrador para su transferencia, y ahora está en §l§3Island_456 §r§f."}]}
execute @a[scores={admintp=150,language=6},tag=admin] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aоперация выполнена! §fВы используете систему Администратора для доставки, вы находитесь на §l§3Island_456 §r§f."}]}
