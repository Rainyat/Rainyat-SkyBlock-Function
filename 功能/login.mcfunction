...
tellraw @a[scores={login=0,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f当前正在运行 雨逸阁空岛生存函数包 v4.6.0 PRO"}]}
tellraw @a[scores={login=0,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fCurrently running Rainyat SkyBlock Function v4.6.0 PRO"}]}
tellraw @a[scores={login=0,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f當前正在運行 雨逸閣空島生存函數包 v4.6.0 PRO"}]}
...
execute @a[scores={login=3,language=0}] ~ ~ ~ title @s subtitle §f雨逸阁空岛生存函数包 v4.6.0 PRO
execute @a[scores={login=3,language=1}] ~ ~ ~ title @s subtitle §fRainyat SkyBlock Function v4.6.0 PRO
execute @a[scores={login=3,language=2}] ~ ~ ~ title @s subtitle §f雨逸閣空島生存函數包 v4.6.0 PRO
